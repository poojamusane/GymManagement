...
const SearchCustomer = () => {
  ...
  const retrieveAllCustomer = async () => {
    ...
    const response = await axios.get(
      "http://localhost:8089/api/admin/allcustomer"
    );
  ...
  const retrieveAllCustomerByClientId = async () => {
    const response = await axios.get(
      "http://localhost:8089/api/admin/search/customer/clientId?clientId=" +
        clientId
    );
    console.log(response.data);
    return response.data;
  ...
  const retrieveAllCustomerByCustomerName = async () => {
    const response = await axios.get(
      "http://localhost:8089/api/admin/search/customer/name?customerName=" +
        customerName
    );
    console.log(response.data);
    return response.data;
